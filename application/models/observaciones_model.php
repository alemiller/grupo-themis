...
class Observaciones_model extends CI_Model {
    ...
    public function list_observaciones() {
    ...
    public function create($data) {
        ...
        $this->db->set('texto', $data_obj->texto);
        

        $this->db->insert('observaciones');
        ...
        if ($result) {
            ...
            $query = $this->db->get_where('observaciones', array('id' => $id));
