...
<section id="widget-grid" class="">
    ...
    <div class="collapse navbar-collapse navbar-default navbar-custom">
        <ul class="nav navbar-nav">
            <li>
                <a id="nueva-clcase-btn" class="nuevo-item" href="javascript:void(0);">Nueva Clase</a>
            </li>
            <li>
                <a id="borrar-clase-btn" class="borrar-item" href="javascript:void(0);">Borrar Clase(s)</a>
            </li>
        </ul>
    </div> 
    <br>
            ...
            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-x" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <table id="clases-tramites-table" class="table table-striped table-bordered table-hover main-grid">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                if (isset($clases)) {
                                    ...
                                    for ($i = 0; $i < sizeof($clases); $i++) {
                                        ?>
                                        <tr id="<?php echo $clases[$i]->id; ?>" class="row-item">
                                            <td class='chbx-item-cell'><input type='checkbox' class='chbx-item'></td>
                                            <td class="clickeable-item"><?php echo $clases[$i]->id; ?></td>
                                            <td class="row-nombre clickeable-item"><?php echo $clases[$i]->nombre; ?></td>
                                            <td class="row-duracion clickeable-item"><?php echo $clases[$i]->duracion; ?></td>
                                        </tr>
                    ...
                    <div class="widget-body">
                        <div class="metadata">
                            <div class='form-group col-md-12'>
                                ...
                                <div class='col-md-12'>
                                    <input id='clase-id' class='form-control metadata'  type='text' disabled="disabled" readonly="readonly"/>
                                </div>
                            </div>
                            ...
                            <div class='form-group col-md-12'>
                                ...
                                <div class='col-md-12'>
                                    <input id='clase-nombre' class='form-control metadata mandatory'  type='text' disabled="disabled"/>
                            ...
                            <div class='form-group col-md-12'>
                                ...
                                <div class='col-md-12'>
                                    <input id='clase-duracion' class='form-control metadata'  type='text' disabled="disabled"/>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    loadScript("<?php echo base_url(); ?>assets/js/clases_tramite.js");
    ...
    $(document).ready(function () {
         ...
         * BASIC
         */
        clases_tramite_table = $('#clases-tramites-table').dataTable({
