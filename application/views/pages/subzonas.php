...
<section id="widget-grid" class="">
    ...
    <div class="collapse navbar-collapse navbar-default navbar-custom">
        <ul class="nav navbar-nav">
            <li>
                <a id="nueva-clcase-btn" class="nuevo-item" href="javascript:void(0);">Nueva Subzona</a>
            </li>
            <li>
                <a id="borrar-subzona-btn" class="borrar-item" href="javascript:void(0);">Borrar Subzona(s)</a>
            </li>
        </ul>
    </div> 
    <br>
            ...
            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-x" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <table id="subzonas-table" class="table table-striped table-bordered table-hover main-grid">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                if (isset($subzonas)) {
                                    ...
                                    for ($i = 0; $i < sizeof($subzonas); $i++) {
                                        ?>
                                        <tr id="<?php echo $subzonas[$i]->id; ?>" class="row-item">
                                            <td class='chbx-item-cell'><input type='checkbox' class='chbx-item'></td>
                                            <td class="clickeable-item"><?php echo $subzonas[$i]->id; ?></td>
                                            <td class="row-nombre clickeable-item"><?php echo $subzonas[$i]->nombre; ?></td> 
                                        </tr>
                    ...
                    <div class="widget-body">
                        <div class="metadata">
                            <div class='form-group col-md-12'>
                                ...
                                <div class='col-md-12'>
                                    <input id='subzona-id' class='form-control metadata'  type='text' disabled="disabled" readonly="readonly"/>
                                </div>
                            </div>
                            ...
                            <div class='form-group col-md-12'>
                                ...
                                <div class='col-md-12'>
                                    <input id='subzona-nombre' class='form-control metadata mandatory'  type='text' disabled="disabled"/>
                            ...
                            <div class='form-group col-md-12'>
                                ...
                                <div class='col-md-12'>
                                    ...
                                    <select id="id_zona" class="form-control metadata" disabled="disabled">
                                        <option value="null">Elija una opción</option>
                                        <?php
                                        if (isset($zonas)) {
                                            for ($i = 0; $i < sizeof($zonas); $i++) {
                                                echo '<option value="' . $zonas[$i]->id . '">' . $zonas[$i]->nombre . '</option>';
                                            }
                                        }
                                        ?>
                                    </select> <i></i> 
...
<script type="text/javascript">
    loadScript("<?php echo base_url(); ?>assets/js/subzonas.js");
    ...
    $(document).ready(function () {
         ...
         * BASIC
         */
        subzonas_table = $('#subzonas-table').dataTable({
