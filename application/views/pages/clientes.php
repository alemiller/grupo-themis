...
<!--                        <div id="clientes-btns" class="col-sm-12 text-align-right">
                            <a id="nuevo-cliente-btn" class="btn btn-success" href="javascript:void(0);"><i class="fa fa-plus"></i> Nuevo Cliente</a>
                            <a id="borrar-cliente-btn" class="btn btn-danger" href="javascript:void(0);"><i class="fa fa-trash-o"></i> Borrar Cliente</a>
                        </div>-->
                    </div>
