...
$(document).ready(function () {
    ...
    $('#logout a').click(function (e) {
        ...
        $.SmartMessageBox({
            ...
            content: $.logoutMSG || "Estas seguro que deseas salir?",
            buttons: '[No][Yes]'
...
if ($.navAsAjax)
{
    ...
    $(document).on('click', '.nav-bread-link', function (e) {
...
function checkURL() {
    ...
    if (url) {
        ...
        var openedSign = '<em class="fa fa-minus-square-o"></em>';
        // remove all active class
        $('nav li.active').removeClass("open");
        $('nav li.active').removeClass("active");
        // match the url and add the active class
        $('nav li:has(a[href="' + url + '"])').addClass("active");
        $('nav li:has(a[href="' + url + '"])').find("b:first").html(openedSign);

        $('nav li.active').each(function (index) {

            if ($(this).children('a.nav-menu-link').parent('li').children('ul')) {
                $(this).addClass('open');
        ...
        if (flag) {
            url = full_url;
            if ($('nav li.active').children("ul:first").length) {

                $('nav li:has(a[href="' + url + '"])').addClass("open");
                $('nav li:has(a[href="' + url + '"])').find("ul:first").slideDown();
            }
        }
        ...
        //update hash
        window.location.href = "index.php/main#dashboard"; //$this.attr('href');
