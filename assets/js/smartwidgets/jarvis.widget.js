...
//console.log($(".dataContent:visible").attr('id'));
//                var idDisplayNone = $(".dataContent:visible").attr('id');
//                $('.dataContent').css('display','none');
//                $('#'+idDisplayNone).css('display','block');
                var thisWidget = $(this)
                    .parents(self.o.widgets);
                var thisWidgetContent = thisWidget.children('div:visible');
                /**
                 * Run function for the indicator image.
                 **/
